...
try:
    ...
    # scico not available - Define dummy classes to allow module import
    class MicrostructureOperator:
        def __init__(self, *args, **kwargs):
            raise ImportError("SCICO is required for MicrostructureOperator. Install scico to use this feature.")

    class AMICOSolver:
        def __init__(self, *args, **kwargs):
             raise ImportError("SCICO is required for AMICOSolver.")

    class GlobalOptimizer:
        def __init__(self, *args, **kwargs):
             raise ImportError("SCICO is required for GlobalOptimizer.")
