...
def main():
    ...
    print("=" * 78)
    print("dmipy-JAX connectivity on DiSCo (§22 — stick + zeppelin)")
    print("=" * 78)
    ...
    for snr in args.snrs:
        print(f"\n=== SNR = {snr} ===")
        res = run_zeppelin_connectivity(snr=snr, library_size=args.library_size)
    ...
    out_npz = Path("validation/dmipy_disco_connectivity_zeppelin_results.npz")
    np.savez(
        out_npz,
